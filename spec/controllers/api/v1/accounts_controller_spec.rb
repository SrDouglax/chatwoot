  ...
  describe 'PATCH /api/v1/accounts/{account.id}' do
    ...
    context 'when it is an authenticated user' do
      params = {
        ...
        auto_assign_agent_unique_team: true,
      ...
      it 'modifies an account' do
        ...
        %w[auto_resolve_after auto_resolve_message auto_resolve_ignore_waiting auto_assign_agent_unique_team].each do |attribute|
