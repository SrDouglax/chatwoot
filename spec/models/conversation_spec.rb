...
RSpec.describe Conversation do
  ...
  describe '#botinbox: when conversation created inside inbox with agent bot' do
    ...
    it 'keeps the conversation unassigned while the inbox bot handles automation' do
    ...
    context 'with campaigns' do
      ...
      it 'returns conversation as open if campaign has no sender and bot is active' do
