class Api::V1::Accounts::InboxesController < Api::V1::Accounts::BaseController
  ...
  def update
    ...
    ActiveRecord::Base.transaction do
      ...
      ::Conversations::StatusSettingsUpdater.new(inbox: @inbox, attributes: inbox_params).perform
  ...
  def inbox_attributes
    [:name, :avatar, :greeting_enabled, :greeting_message, :enable_email_collect, :csat_survey_enabled,
     :enable_auto_assignment, :working_hours_enabled, :out_of_office_message, :timezone, :allow_messages_after_resolved, :business_name,
